...
public class HUDsurvival : HUD {
	...
	protected override void OnGUI()
	{
		...
		float positionY = iconSize * 3 / levelMgr.NumWaypoints;
		//Waypoints
		for (int i = 0; i < levelMgr.NumWaypoints-waypoint.CurrentWaypoint; i++) {
		...
		//Waypoints pass
		for (int i = levelMgr.NumWaypoints-waypoint.CurrentWaypoint; i < levelMgr.NumWaypoints; i++) {
